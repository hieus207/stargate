"use strict";
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[1357], {
    ...
    52805: function(e, t, n) {
        ...
        function i(e) {
            if (!e)
                return;
            let t = a.WI.getFiatAmount(e, a.Yw.USD);
            return null == t ? void 0 : t.value
        }
    },
    86084: function(e, t, n) {
        n.d(t, {
            _: function() {
                return d
            }
        ...
        var a = n(38623)
          , i = n(3566)
          , s = n(41270);
        let d = n(72270).D.extend({
            type: s.ZP.enum(["stargateStaking"]),
            rewards: s.ZP.array(a.TR),
            stargateVersion: s.ZP.literal(i.C.V2)
        })
    },
    72270: function(e, t, n) {
        n.d(t, {
            D: function() {
                return d
            }
        ...
        let d = s.z.object({
            ...
            chainKey: s.z.string(),
            lpToken: a.iK,
            disabled: s.z.boolean().optional(),
            stargateVersion: s.z.enum([i.C.V1, i.C.V2])
        })
    },
    27731: function(e, t, n) {
        ...
        class s {
            getDeployments() {
                return Object.values(this.stargateConfigs).flatMap(e => Object.values(e.deployments))
            }
            tryGetConfig(e) {
                for (let a of this.stargateConfigs) {
                    var t, n;
                    let i = a.deployments[e.chainKey];
                    if (i && ((null === (t = i.stargatePool) || void 0 === t ? void 0 : t.address) === e.address || (null === (n = i.stargatePoolNative) || void 0 === n ? void 0 : n.address) === e.address))
                        return a
                }
            }
            getConfig(e) {
                let t = this.tryGetConfig(e);
                if (t)
                    return t;
                throw Error("Config not found for pool ".concat(e.address, " on chain ").concat(e.chainKey))
            }
            getConfigs() {
                return this.stargateConfigs
            }
            tryGetPool(e) {
                return this.pools.find(t => t.token === e)
            }
            getPools() {
                return this.pools
            }
            getPool(e) {
                let t = this.tryGetPool(e);
                if (t)
                    return t;
                throw Error("Pool not found for token ".concat(e.symbol, " on chain ").concat(e.chainKey))
            }
            constructor(e) {
                for (let n of (this.stargateConfigs = e,
                this.pools = [],
                e))
                    for (let e in n.deployments) {
                        var t;
                        let s = n.deployments[e]
                          , d = null !== (t = s.stargatePool) && void 0 !== t ? t : s.stargatePoolNative;
                        d && ((0,
                        a.hu)(s.lpToken, "lpToken is required for pool deployment"),
                        this.pools.push({
                            eid: s.eid,
                            chainKey: e,
                            address: d.address,
                            token: s.token,
                            lpToken: s.lpToken,
                            sharedDecimals: n.sharedDecimals,
                            stargateVersion: i.C.V2
                        }))
                    }
            }
        }
    ...
    18226: function(e, t, n) {
        ...
        function i(e) {
            (0,
            a.hu)(e.srcChainKey === e.srcToken.chainKey, "Provided srcChainKey does not match srcToken.chainKey"),
            (0,
            a.hu)(e.dstChainKey === e.dstToken.chainKey, "Provided dstChainKey does not match dstToken.chainKey"),
            (0,
            a.hu)(e.srcToken.equals(e.srcAmount.token), "Provided srcToken does not match amount.currency"),
            (0,
            a.hu)(e.dstToken.equals(e.dstAmountMin.token), "Provided dstToken does not match minAmount.currency"),
            2 === e.adapterParams.version && ((0,
            a.hu)(e.adapterParams.dstNativeAmount, "Provided empty adapterParams.dstNativeAmount"),
            (0,
            a.hu)(e.adapterParams.dstNativeAmount.token.equals((0,
            a.JK)(e.dstChainKey)))),
            (0,
            a.hu)(e.srcAddress, "Provided empty srcAddress"),
            (0,
            a.hu)(e.dstAddress, "Provided empty dstAddress"),
            (0,
            a.hu)("adapterParams"in e && e.adapterParams, "Provided empty adapterParams")
        }
    },
    51436: function(e, t, n) {
        ...
        var a = n(34541)
          ...
          , r = (e, t, n) => (d(e, "symbol" != typeof t ? t + "" : t, n),
        n);
        ( (e, t) => {
            for (var n in t)
                s(e, n, {
            ...
            ERC20__factory: () => l,
            Factory__factory: () => c,
            FeeDistributor__factory: () => b,
            LPStakingTime__factory: () => h,
            LPStaking__factory: () => f,
            MerkleDropV2__factory: () => g,
            Pool__factory: () => w,
            RouterETH__factory: () => x,
            Router__factory: () => C,
            SVotingEscrow__factory: () => R,
            StargateFeeLibrary__factory: () => S,
            StargateToken__factory: () => B,
            StargateWidget__factory: () => M,
            VotingEscrow__factory: () => K,
            WhitelistAuction__factory: () => O
        });
        var o = [{
            inputs: [{
    ...
    24906: function(e, t, n) {
        ...
        var a, i, s = n(51436), d = n(41270), r = n(38623), o = n(18226), y = n(35440), p = n(6518);
        n(20948);
        var l = n(48224)
          , u = {
            V1: "v1"
        }
          , c = d.ZP.union([d.ZP.object({
            address: d.ZP.string()
        }), d.ZP.string()]).transform(e => "string" == typeof e ? {
            address: e
        } : e)
          , m = d.ZP.object({
            srcEid: d.ZP.number(),
            dstEid: d.ZP.number(),
            srcPoolId: d.ZP.number(),
            dstPoolId: d.ZP.number(),
            ready: d.ZP.boolean(),
            weight: d.ZP.number()
        })
          , b = d.ZP.object({
            eid: d.ZP.number(),
            router: c.optional(),
            routerEth: c.optional(),
            bridge: c.optional(),
            factory: c.optional(),
            poolView: c.optional(),
            lpStaking: c.array().optional(),
            lpStakingTime: c.array().optional(),
            stargateToken: c.optional(),
            stargatePreCrime: c.optional(),
            widgetSwap: c.optional()
        })
          , T = d.ZP.object({
            disabled: d.ZP.boolean().optional(),
            poolId: d.ZP.number(),
            chainKey: d.ZP.string(),
            token: r.TR,
            stargateVersion: d.ZP.literal(u.V1),
            address: d.ZP.string(),
            decimals: d.ZP.number(),
            sharedDecimals: d.ZP.number(),
            symbol: d.ZP.string()
        })
          , f = d.ZP.object({
            deployments: d.ZP.record(b),
            chainPaths: m.array(),
            pools: T.array()
        }).transform( (e, t) => {
            let n = {
                rules: [],
                deployments: {},
                chainPaths: e.chainPaths,
                pools: []
            };
            for (let t in e.deployments) {
                let {stargateToken: a, factory: i, lpStaking: s, lpStakingTime: d, router: o, routerEth: y, eid: p, bridge: l} = e.deployments[t]
                  , u = {
                    eid: p,
                    chainKey: t,
                    router: o && {
                    ...
                    lpStakingTime: d && d.map(e => ({
                        address: e.address,
                        chainKey: t
                    })),
                    stargateToken: a && r.WU.from({
                        symbol: "STG",
                        decimals: 18,
                        address: a.address,
                        chainKey: t
            ...
            for (let a of e.pools) {
                let e = n.deployments[a.chainKey];
                if (!e) {
                    t.addIssue({
                        code: d.ZP.ZodIssueCode.custom,
                        message: "Deployment not found for pool ".concat(a.symbol, " on chain ").concat(a.chainKey)
                    });
                    continue
                }
                let i = r.WU.from({
        ...
        f.parse(i))
          , I = class {
            ...
            async getAllowance(e) {
                ...
                if ((0,
                r.iI)(t))
                    return r.ih.fromBigInt(t, r.Bz);
                let a = t.chainKey
                  , i = this.sdk.getRouterAddress(a);
                return this.erc20.forToken(t).allowance(n, i)
            }
            async approve(e) {
                let {amount: t} = e
                  , n = t.token.chainKey
                  , a = this.sdk.getRouterAddress(n);
                return this.erc20.forToken(t.token).approve(t, a)
            }
            supportsTransfer(e, t) {
                let n = this.sdk.tryGetLink(e, t);
                return !!n && !n.srcPool.disabled && !n.dstPool.disabled && 0 !== n.chainPath.weight && !!(0,
                r.ld)(n.srcPool.chainKey) && n.chainPath.ready
            }
            supportsClaim(e) {
                return !1
            }
            supportsRegister(e) {
                return !!this.sdk.getPools().some(t => t.token.equals(e))
            }
            ...
            async getUnclaimed(e) {
                let {token: t} = e;
                return r.ih.fromBigInt(t, BigInt(0))
            }
            claim(e) {
            ...
            validateInput(e) {
                (0,
                o.b)(e);
                let {srcPool: t, dstPool: n} = this.sdk.getLink(e.srcToken, e.dstToken);
                (13 === t.poolId || 13 === n.poolId) && ((0,
                r.hu)(13 === t.poolId, "srcPool is not ETH"),
                (0,
                r.hu)(13 === n.poolId, "dstPool is not ETH")),
                (0,
                r.hu)(t.chainKey === e.srcChainKey, "srcPool (".concat(t.chainKey, ") and srcChainKey (").concat(e.srcChainKey, ") do not match")),
                (0,
                r.hu)(n.chainKey === e.dstChainKey, "dstPool (".concat(n.chainKey, ") and dstChainId (").concat(e.dstChainKey, ") do not match"))
            }
            transfer(e) {
                this.validateInput(e);
                let {srcPool: t} = this.sdk.getLink(e.srcToken, e.dstToken);
                return 13 === t.poolId ? this.transferEth(e) : this.transferToken(e)
            }
            async transferEth(e) {
                let t = e.srcChainKey
                  , {srcPool: n, dstPool: a} = this.sdk.getLink(e.srcToken, e.dstToken);
                (0,
                r.hu)(13 === n.poolId, "eth"),
                (0,
                r.hu)(13 === a.poolId, "eth");
                let i = this.providerFactory(e.srcChainKey)
                  , d = this.sdk.getRouterEthAddress(n.chainKey)
                  , o = s.Sh.connect(d, i)
                  , p = e.srcAmount.quotient
                  , l = e.dstAmountMin.quotient
                  , u = a.eid
                  , {srcAddress: c, dstAddress: m} = e
                  , b = e.srcAmount.add(e.fee.nativeFee).quotient
                  , T = o.populateTransaction.swapETH(u, c, m, p, l, {
                    value: b,
                    from: c
                });
                return (0,
            ...
            async transferToken(e) {
                (0,
                o.b)(e);
                let t = e.srcChainKey
                  , {srcPool: n, dstPool: a} = this.sdk.getLink(e.srcToken, e.dstToken)
                  , i = this.providerFactory(e.srcChainKey)
                  , s = this.getRouterContract(n.chainKey)
                  , d = e.srcAmount.quotient
                  , p = (0,
                r.ph)(e.dstAmountMin, e.srcToken).quotient
                  , {adapterParams: l} = e
                  , u = a.eid
                  , c = n.poolId
                  , m = a.poolId
                  , {srcAddress: b, dstAddress: T} = e
                  , f = this.lzTxParams(l)
                  , E = e.fee.nativeFee.quotient
                  , h = s.populateTransaction.swap(u, c, m, b, d, p, f, T, "0x", {
                    value: E,
                    from: b
                });
                return (0,
            ...
            async getMessageFee(e) {
                let {srcToken: t, dstToken: n, adapterParams: a} = e
                  , i = t.chainKey
                  , s = n.chainKey
                  , d = this.chainKeyToEndpointId(s)
                  , o = this.getRouterContract(i)
                  , p = this.lzTxParams(a)
                  , l = (0,
                r.JK)(i)
                  , [u,c] = await o.quoteLayerZeroFee(d, 1, y.F0, "0x", p);
                return {
                    nativeFee: r.ih.fromBigInt(l, u.toBigInt()),
                    zroFee: r.ih.fromBigInt(l, c.toBigInt())
                }
            }
            lzTxParams(e) {
                var t;
                return {
                    dstGasForCall: e.extraGas,
                    dstNativeAddr: null !== (t = e.dstNativeAddress) && void 0 !== t ? t : y.F0,
                    dstNativeAmount: e.dstNativeAmount ? e.dstNativeAmount.quotient : p._Y
                }
            }
            async getFeeLibrary(e) {
                let t = await this.getFeeLibraryAddress(e)
                  , n = this.providerFactory(e.chainKey);
                return s.Nv.connect(t, n)
            }
            async getOutput(e) {
                let {srcAmount: t, dstToken: n} = e
                  , a = t.token
                  , {srcPool: i, dstPool: s} = this.sdk.getLink(a, n)
                  , d = await this.getFeeLibrary(i.lpToken)
                  , o = g(t, i.lpToken)
                  , p = i.poolId
                  , l = s.poolId
                  , u = s.eid
                  , c = y.F0
                  , m = await d.getFees(p, l, u, c, o.quotient)
                  , b = {
                    eqFee: r.ih.fromBigInt(i.lpToken, m.eqFee.toBigInt()),
                    eqReward: r.ih.fromBigInt(i.lpToken, m.eqReward.toBigInt()),
                    lpFee: r.ih.fromBigInt(i.lpToken, m.lpFee.toBigInt()),
                    protocolFee: r.ih.fromBigInt(i.lpToken, m.protocolFee.toBigInt()),
                    lkbRemove: r.ih.fromBigInt(i.lpToken, m.lkbRemove.toBigInt())
                }
                  , T = {
                    eqFee: P(b.eqFee, i.token),
                    eqReward: P(b.eqReward, i.token),
                    lpFee: P(b.lpFee, i.token),
                    protocolFee: P(b.protocolFee, i.token),
                    lkbRemove: P(b.lkbRemove, i.token)
                }
                  , f = b.eqFee.add(b.protocolFee).add(b.lpFee).subtract(b.eqReward)
                  , E = P(f, a);
                return {
                    dstAmount: P(g(t, i.lpToken).subtract(f), s.token),
                    fee: {
                        totalFee: E,
                        ...T
                    }
            ...
            async getLimit(e) {
                let {srcToken: t, dstToken: n} = e
                  , {srcPool: a, dstPool: i} = this.sdk.getLink(t, n)
                  , d = this.providerFactory(a.chainKey)
                  , o = s.RX.connect(a.lpToken.address, d)
                  , y = i.eid
                  , p = i.poolId
                  , l = await o.getChainPath(y, p);
                return P(r.ih.fromBigInt(a.lpToken, l.balance.toBigInt()), t)
            }
            async getExtraGas(e) {
                return 0
            }
            ...
            chainKeyToEndpointId(e) {
                return this.sdk.getDeployment(e).eid
            }
            getRouterContract(e) {
                let t = this.sdk.getRouterAddress(e)
                  , n = this.providerFactory(e);
                return s.Gh.connect(t, n)
            }
            constructor(e, t) {
                this.feeLibraryCache = new Map,
                this.getFeeLibraryAddress = l(async e => {
                    let t = this.providerFactory(e.chainKey);
                    return s.RX.connect(e.address, t).feeLibrary()
                }
                , {
                    cacheKey: e => {
                        let[t] = e;
                ...
                this.sdk = t,
                this.erc20 = new y.gp(e)
            }
        }
        ;
        function g(e, t) {
            let n = t.decimals;
            return r.ih.fromBigInt(t, e.multiply(BigInt(10) ** BigInt(n)).divide(e.decimalScale).quotient)
        }
        function P(e, t) {
            let n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : t.decimals;
            return r.ih.fromBigInt(t, e.multiply(BigInt(10) ** BigInt(n)).divide(e.decimalScale).quotient)
        }
        var w = class {
            update(e) {
                this.updateEndpointIdToChainKeyMap(e),
                this.updateChainPaths(e)
            }
            tryGetDeployment(e) {
            ...
            getDeployment(e) {
                ...
                if (t)
                    return t;
                throw Error("No deployment for chainKey: ".concat(e))
            }
            updateEndpointIdToChainKeyMap(e) {
                for (let t in this.endpointIdToChainKeyMap.clear(),
                e.deployments) {
                    let n = e.deployments[t];
                    this.endpointIdToChainKeyMap.set(n.eid, t)
                }
            }
            chainKeyToEndpointId(e) {
            ...
            endpointIdToChainKey(e) {
                let t = this.endpointIdToChainKeyMap.get(e);
                if (t)
                    return t;
            ...
            updateChainPaths(e) {
                let t = [];
                for (let n of e.chainPaths)
                    try {
                        let e = this.endpointIdToChainKey(n.srcEid)
                          , a = this.endpointIdToChainKey(n.dstEid)
                          , i = this.getPool({
                            poolId: n.srcPoolId,
                            chainKey: e
                        })
                          ...
                          , d = {
                            disabled: i.disabled || s.disabled || !1,
                            srcPool: i,
                            dstPool: s,
                            chainPath: n
                        };
                        ...
                        this.log.error("Could not add chain path ".concat(JSON.stringify(n)), e)
                    }
                this.poolLinks = t
            }
            tryGetPool(e) {
                if ("address"in e) {
                    ...
                    for (let e of this.config.pools)
                        if (e.chainKey === t && e.address === n)
                            return e
                }
                if ("poolId"in e) {
                    let {chainKey: t, poolId: n} = e;
                    for (let e of this.config.pools)
                        if (e.chainKey === t && e.poolId === n)
                            return e
                }
            }
            getPool(e) {
                ...
                if (t)
                    return t;
                throw Error("No pool for ".concat(JSON.stringify(e)))
            }
            tryGetRouterAddress(e) {
                var t, n;
                return null === (n = this.tryGetDeployment(e)) || void 0 === n ? void 0 : null === (t = n.router) || void 0 === t ? void 0 : t.address
            }
            tryGetRouterEthAddress(e) {
                var t, n;
                return null === (n = this.tryGetDeployment(e)) || void 0 === n ? void 0 : null === (t = n.routerEth) || void 0 === t ? void 0 : t.address
            }
            isPathDisabled(e, t) {
                if (this.getPool(e).disabled || this.getPool(t).disabled)
                    return !0;
                for (let n of this.config.rules)
                    if ((!n.srcChainKey || e.chainKey === n.srcChainKey) && (!n.dstChainKey || t.chainKey === n.dstChainKey) && (!n.srcChainKey || e.poolId === n.srcPoolId) && (!n.dstPoolId || t.poolId === n.dstPoolId))
                        return !0;
                return !1
            }
            get pools() {
            ...
            constructor(e) {
                this.poolLinks = [],
                this.endpointIdToChainKeyMap = new Map,
                this.log = console,
                this.getActiveLinks = () => this.poolLinks.filter(e => e.chainPath.ready && !e.srcPool.disabled && !e.dstPool.disabled),
                this.getLinks = () => this.poolLinks,
                this.getPools = () => this.config.pools,
                this.getLink = (e, t) => {
                    let n = this.tryGetLink(e, t);
                    if (n)
                        return n;
                ...
                this.tryGetLink = (e, t) => {
                    if (e && t) {
                        for (let n of this.poolLinks)
                            if (n.srcPool.token.equals(e) && n.dstPool.token.equals(t))
                                return n
                    }
                }
                ,
                this.tryGetPath = (e, t) => {
                    var n;
                    return null === (n = this.tryGetLink(e, t)) || void 0 === n ? void 0 : n.chainPath
                }
                ,
                this.getPath = (e, t) => {
                    let n = this.tryGetPath(e, t);
                    if (n)
                        return n;
                    throw Error("No path found")
                }
                ,
                this.getRouterAddress = e => {
                    let t = this.tryGetRouterAddress(e);
                    if (t)
                        return t;
                    throw Error("No router address for chainKey: ".concat(e))
                }
                ,
                this.getRouterEthAddress = e => {
                    let t = this.tryGetRouterEthAddress(e);
                    if (t)
                        return t;
                    throw Error("No router ETH address")
                }
                ,
                this.getWidgetAddress = e => {
                    let t = this.tryGetWidgetAddress(e);
                    if (t)
                        return t;
                    throw Error("No widget address for chainKey: ".concat(e))
                }
                ,
                this.tryGetWidgetAddress = e => {
                    throw Error("tryGetWidgetAddress not implemented")
                }
                ,
                this.config = e,
                this.update(e)
